...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			<ul class="sub">
				<!--<li><a href="?page=input_siswa">Input Data User</a></li>
				<li><a href="?page=input_guru">Input Data Pegawai</a></li>
				<li><a href="?page=input_mapel">Input Mata Pelajaran</a></li>
				<li><a href="?page=input_kelas">Input Ruang Kelas</a></li>-->
				<li><a href="?page=input_pegawai">Input Pegawai</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
		...
		<div class="select_sub">
			<ul class="sub">
				<!--<li><a href="?page=lihat_siswa">Data User</a></li>
				<li><a href="?page=lihat_guru">Data Pegawai</a></li>
				<li><a href="?page=lihat_kelas">Data Kelas</a></li>
				<li><a href="?page=lihat_mapel">Mata Pelajaran</a></li>-->
				<li><a href="?page=lihat_pegawai">Data Pegawai</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
