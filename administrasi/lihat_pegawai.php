...
<h1><div align="center">Data Pegawai</div></h1><br /><hr><br />
<body>
	<div class="page" id="tablewrapper">
        ...
        <table width="708" border="0" cellpadding="0" cellspacing="0" class="tinytable" id="table">
            <thead>
                <tr>
                  <th width="86"><h3>ID Pegawai</h3></th>
		 ...
		 if($_SESSION['level']=="admin" || $_SESSION['level']=="tu"){
			echo "
			<a href=edit_pegawai.php?id=$baris[idwali_murid]><img src=icon/update.png border=0></a>&nbsp;|
			<a href=hapus_pegawai.php?id=$baris[idwali_murid] onClick=\"return confirm('Apakah Anda Yakin Akan Menghapus Data?')\"><img src=icon/hapus.png border=0></a></td>
            </tr>";
			}}
			?>
            </tbody>
