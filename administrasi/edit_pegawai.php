...
<h2 align="center"><u>Input Data Pegawai</u></h2>

<table border="1" align="center"><tr><td>
<form onKeyUp="highlight(event)" onClick="highlight(event)" name="form" id="form" class="form" action="update_pegawai.php" onsubmit="return validate(this)" method="post">
<input type="hidden" name="idlama" value="<?php echo $hasil['idwali_murid']; ?>"  />
<table width="473" border="0" align="center" style="margin:20px;">
  <tr>
    <td width="150" height="37">ID Pegawai</td>
    <td width="17">:</td>
